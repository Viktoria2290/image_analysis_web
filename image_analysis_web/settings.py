...
ROOT_URLCONF = 'image_analysis_web.urls'
...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'image_analysis_db'),
...
# Database - ИСПРАВЛЕННАЯ КОНФИГУРАЦИЯ
DATABASE_URL = os.getenv('DATABASE_URL')
if DATABASE_URL:
    # Для Docker и production
    import dj_database_url
...
# УБРАЛ CELERY - Redis не используется в нашем проекте
